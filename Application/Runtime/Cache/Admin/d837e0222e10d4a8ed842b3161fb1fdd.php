            ...
            <tr>
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>"><?php echo ($vo["_cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                        ...
                        $(function() {
                            $('#file_upload').uploadify({
                                ...
                                'onUploadSuccess' : function(file, data, response) {
                                    ...
                                    $('#art_thumb_img').attr('src',''+data).css('width','80');//给图片添加src
//                                    alert(data);
                                }
                            });
                        });
            ...
            <tr>
                <th></th>
                <td>
                    <input type="button" value="提交" onclick="Article.addCheck()">
