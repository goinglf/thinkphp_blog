        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="/index.php/admin/category/cateList"><i class="fa fa-refresh"></i>更新排序</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        <td class="tc">
                            <input type="text" name="cate_order" value="<?php echo ($vo["cate_order"]); ?>" onchange="Category.changOrder(this,<?php echo ($vo["cate_id"]); ?>)">
                        </td>
                        ...
                        <td>
                            ...
                            <a  onclick="Category.del(<?php echo ($vo["cate_id"]); ?>)">删除</a>
                        </td>
                    </tr>
