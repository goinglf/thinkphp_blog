            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                <?php if(is_array($data1)): $i = 0; $__LIST__ = $data1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['cate_id'] == $data['cate_pid']): ?><option value="<?php echo ($vo["cate_id"]); ?>" selected><?php echo ($vo["cate_name"]); ?></option>
                                     <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="cate_order" value="<?php echo ($data['cate_order']); ?>">
                            <p>请输入数字</p>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
                            <input type="button" value="提交" onclick="Category.edit(<?php echo ($data['cate_id']); ?>)">
